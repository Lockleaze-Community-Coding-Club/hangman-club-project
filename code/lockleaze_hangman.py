...
## Rick@LAPTOP-IK2NAICQ MINGW64 /c/Lockleaze Hangman/hangman-club-project (master)
## $ python code/lockleaze_hangman.py
## empty string -- this needs to contain the word chosen and the masked version to display on the screen
